...
80104314:	e8 37 f4 ff ff       	call   80103750 <mycpu>
  for(i = 0; i < 10; i++){
...
8010438b:	68 43 75 10 80       	push   $0x80107543
...
801043e5:	68 4b 75 10 80       	push   $0x8010754b
801043ea:	e8 a1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043ef:	83 ec 0c             	sub    $0xc,%esp
801043f2:	68 62 75 10 80       	push   $0x80107562
...
8010441d:	68 69 75 10 80       	push   $0x80107569
...
80104437:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
  __sync_synchronize();
8010443e:	f0 83 0c 24 00       	lock orl $0x0,(%esp)
  asm volatile("movl $0, %0" : "+m" (lk->locked) : );
80104443:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
}
...
8010444e:	5d                   	pop    %ebp
  popcli();
8010444f:	e9 4c ff ff ff       	jmp    801043a0 <popcli>
...
801056c4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801056ca:	e8 21 eb ff ff       	call   801041f0 <initlock>
}
...
80105938:	e8 a3 e9 ff ff       	call   801042e0 <acquire>
      wakeup(&ticks);
...
80106814:	0f 84 c2 00 00 00    	je     801068dc <switchuvm+0xec>
  pushcli();
8010681a:	e8 81 da ff ff       	call   801042a0 <pushcli>
...
801068c9:	5d                   	pop    %ebp
  popcli();
801068ca:	e9 d1 da ff ff       	jmp    801043a0 <popcli>
...
80106d33:	e8 d8 d7 ff ff       	call   80104510 <memmove>
...
80106d4f:	e8 bc f8 ff ff       	call   80106610 <mappages>
...
80106d6d:	e8 1e f8 ff ff       	call   80106590 <walkpgdir>
...
80106d85:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80106d8b:	e8 40 b7 ff ff       	call   801024d0 <kalloc>
...
80106db7:	68 54 78 10 80       	push   $0x80107854
80106dbc:	e8 cf 95 ff ff       	call   80100390 <panic>
      panic("copyuvm: page not present");
80106dc1:	83 ec 0c             	sub    $0xc,%esp
80106dc4:	68 6e 78 10 80       	push   $0x8010786e
80106dc9:	e8 c2 95 ff ff       	call   80100390 <panic>
...
80106dde:	e8 ad f7 ff ff       	call   80106590 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106e4f:	e8 bc d6 ff ff       	call   80104510 <memmove>
    len -= n;
    buf += n;
